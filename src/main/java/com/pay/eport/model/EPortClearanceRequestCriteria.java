...
public class EPortClearanceRequestCriteria
{
	...
	public EPortClearanceRequestCriteria( )
	{
		oredCriteria = new ArrayList< Criteria >( );
	}

	protected EPortClearanceRequestCriteria( EPortClearanceRequestCriteria example )
	{
